...
def run_inference(version, num_samples=30, resolution=384):
    model_path = f"./output/{version}"
    output_root_dir = f"/home/t/tph777/sdxl/inferred/{version}"
    dataset_dir = "/home/t/tph777/extended_set/newprompt_ds/train"
...
if __name__ == "__main__":    
    ...
    run_inference(args.version, args.num_samples, args.resolution)